...
const Home: React.FC = () => {
    ...
    function onScroll(event: Event): void {
      ...
      sections.forEach((currLink) => {
        ...
        if (val) {
          if (val === '#about') {
                  console.log("onScroll:", val, document.querySelector(val))
          }
  ...
  <div>
   ...
   <div className="ud-header fixed left-0 top-0 z-40 flex w-full items-center bg-primary h-17">
   <div className="container">
      <div className="relative -mx-4 flex items-center justify-between">
         {/* Logo */}
         <div className="w-60 max-w-full px-4">
            <a href="#index" className="block py-5">
            <img
         ...
         <div className="flex w-full items-center justify-between px-4">
            ...
            isMenuOpen ? '' : 'hidden'}`}
               >
                  <ul className="blcok lg:flex 2xl:ml-45">
            ...
            <div className="flex items-center justify-end pr-16 lg:pr-0">
               ...
               <div className="flex items-center justify-end">
                  <a
                     href="/auth/signin"
                     className="loginBtn px-[22px] py-1 text-base font-medium text-white hover:opacity-70 border border-white rounded-xl"
        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4">
              ...
              >
                ...
                >
                "股票市场中特定交易资金流动的动态往往反应着聪明资金做出复杂分析决策后行动的时机和方向。"
                </p>
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            <div className="wow fadeInUp group mb-12 text-center" data-wow-delay=".1s">
              ...
              <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                我们将持续部署新功能包括AI策略、高信噪比社区以及为精英投资者定制的功能。
              </p>
              <a
                  className="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
                >
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 max-w-[580px] lg:mb-0">
                ...
                >
                  ...
                  <br />
                  <br />
                  作为来自香港和华尔街的对冲基金和IBD的资深从业者，以及来自硅谷的资深数据/人工智能从业者，提供值得信赖和有效的产品是我们与客户建立信任的方式。                </p>
              </div>
            </div>
      ...
      <div className="container">
        <div className="wow fadeInUp" data-wow-delay=".2s">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <div className="-mx-2 flex flex-wrap sm:-mx-4 lg:-mx-2 xl:-mx-4">
                <div className="w-full px-2 sm:w-1 sm:px-4 lg:px-2 xl:px-4">
                  <div
                    className="mb-4 sm:mb-8 sm:h-[400px] md:h-[540px] lg:h-[400px] xl:h-[500px]"
                  >
                    <img
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-4 max-w-[580px] lg:pl-20">
                <h2
                  className="mb-5 text-3xl font-bold leading-tight text-dark dark:text-white sm:text-[40px] sm:leading-[1.2]"
                >
                ...
                <p
                  className="mb-10 text-base leading-relaxed text-body-color dark:text-dark-6"
                >
                  The tool is designed to help investors track historical and the latest capital flow dynamics of individual stocks and industries. We believe that the flow momentum of smart money is often the reflection of their final actions under complex decision-making.
                  <br />
                  </p>
              </div>
            </div>
                ...
                >
                  ...
                  <a href="#" className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-body-secondary">来自高瓴资本</p>
                    </div>
                  </a>
                </div>
              </div>
                ...
                >
                  ...
                  <a href="#" className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-body-secondary">6年经验的个人全职投资者</p>
                    </div>
                  </a>
                </div>
              </div>
