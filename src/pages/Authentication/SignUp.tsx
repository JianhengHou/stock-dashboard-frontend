...
//     const {reFetchUserInfo, reFetchUserStripe} = useStripeStatus(); // Use the hook at the top level of your component
  ...
  return (
      <div className="h-screen w-screen flex items-center bg-white justify-center bg-gray-100 dark:bg-gray-900">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSignUp}>
                ...
                <div className="mb-4">
                  <label className="mb-2.5 block font-medium text-black dark:text-white" htmlFor="retype-password">
                    {language === 'en'
                        ? "Password"
                        : '再次输入密码'
                       }
