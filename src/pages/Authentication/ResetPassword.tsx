...
const ResetPassword: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      // Assuming your AWS Cognito setup requires username (email) for password reset
      await resetPassword({username:email});
      setMessage(language === 'en'? 'Verification Code Has been Sent to Your Email.': '验证码已发送至您的邮箱。');
      setError('');
      ...
      console.error(err);
      setError(language === 'en'? 'Failed to send reset password email. Please try again.': '发送重置密码邮箱失败。请重试。');
      setMessage('');
    }
  };
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full xl:w-1/2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <p className="mb-7.5">
                {language === 'en'?'Enter your email address to receive a password reset link.': '填入邮箱接收密码重置链接'}
              </p>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div>
                  <input
                    type="submit"
                    value={language === 'en'? "Send Password Reset Link":'发送密码重置链接'}
