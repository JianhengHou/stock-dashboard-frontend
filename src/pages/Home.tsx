...
import team01 from "../images/team/team_profile.png";
...
className="mb-9 text-xl font-medium text-white lg:text-xl sm:text-sm sm:leading-[1.44]"
          ...
          <div className="w-full px-4">
            ...
            >
              <div className="mt-16">
                <img
                  src={language === 'en'?coverEN:coverCN}
      ...
      <div className="w-full px-4 lg:w-1/2 flex justify-center items-center">
        <div className="overflow-hidden rounded-xl">
          <img
            src={
              language === "en"
                ? capitalHistoryCoverEN
                : capitalHistoryCoverCN
            }
            alt="about image"
...
<div className="container mb-20">
  <div className="wow fadeInUp" data-wow-delay=".2s">
    <div className="-mx-4 flex flex-wrap items-center">
      ...
      {/* Text Container */}
      <div className="w-full px-4 lg:w-1/2 flex flex-col justify-between">
        <div className="text-center max-w-[600px]">
          <h2 className="mb-5 text-3xl font-bold leading-tight text-dark dark:text-white sm:text-[40px] sm:leading-[1.2]">
            {language === "en"
              ? "Diversified Stock Strategies"
    ...
    >
      <div className="container mx-auto">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 lg:w-1/2">
            <div className="mb-16 flex lg:mb-[70px]">
              <div
          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            <div className="-mt-7 mb-12 flex lg:mb-[70px]">
              <div
                className="mr-4 flex h-[50px] w-full max-w-[50px] items-center justify-center rounded-xl bg-primary text-white sm:mr-6 sm:h-[60px] sm:max-w-[60px]"
              >
                <svg
              ...
              <form>
                <div className="mb-[22px]">
                  ...
                  <input
                    type="text"
                    name="fullName"
                    placeholder={language === 'en'? "Your name" :"您的称呼"}
                ...
                <div className="mb-[30px]">
                  ...
                  <textarea
                    name="message"
                    rows="1"
                    placeholder={language === 'en'?  "Type your message here":"在此填入您的消息内容"}
    ...
    >
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              {language === 'en'
              ? "Providing trustworthy and effective products is how we build trust with our customers."
              : "提供值得信赖和有效的产品是我们与客户建立信任的方式。"
              }
              </p>
              ...
              <ul>
                <li>
                  ...
                  >
                    ...
                    {language === 'en'? "Privacy policy":"隐私条款"}
                  </a>
                </li>
                <li>
                  <a
                ...
                <li>
                  <a
                    className="mb-3 inline-block text-base text-gray-7 hover:text-primary"
                  >
                    {language === 'en'? "Refund Policy":"退款政策"}
                  </a>
                </li>
              </ul>
            </div>
      ...
      <div
        className="border-t border-[#8890A4] border-opacity-40 py-8 lg:mt-[60px]"
      >
        <div className="container">
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="mb-5 text-sm text-body-color dark:text-dark-6">
                  Data/AI Product Expert
                </p>
                <p className="text-sm text-body-color dark:text-dark-6">
                  MEGA 7 company in Silicon Valley
                </p>
              </div>
            </div>
          </div>
