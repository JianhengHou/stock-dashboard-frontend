          ...
          <div className="mx-auto w-full max-w-[600px]">
            <div className="text-center">
              ...
              <p className="font-medium">
                {language === 'en' ? 'Our website is currently under construction and we will provide the latest updates and notifications in a timely manner.'
                : '我们的网站目前正在建设中，我们会及时提供最新更新和通知。'}
              </p>
            </div>
          </div>
