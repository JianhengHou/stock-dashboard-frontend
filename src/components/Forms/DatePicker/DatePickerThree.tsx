...
import './DatePickerThree.css'; // Ensure to import your custom CSS

const DatePickerThree = ({ selectedDate, onChange }) => {
  ...
  return (
    <div className="relative">
      <DatePicker
        ...
        calendarClassName="custom-datepicker" // Apply custom class to the calendar
      />
